 ...
 */
root : expression EOF;
expression : multiplication | sum | primitive;
sum : (multiplication | primitive) '+' expression;
multiplication : primitive '*' (multiplication | primitive);
primitive : parentheses | NUMBER | VARIABLE;
